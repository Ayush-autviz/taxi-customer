...
const CreatePassword = (props) => {
    ...
    const call_register = async () => {
        console.log({ fcm_token:'123456', phone_number: props.phone_number, phone_with_code: props.phone_with_code, country_code: props.country_code, first_name: props.first_name, last_name: props.last_name, email: props.email, password: password, referral_code: '' })
        Keyboard.dismiss();
        setLoading(true);
        await axios({
            method: 'post',
            url: api_url + register,
            data: { fcm_token: '123456', phone_number: props.phone_number, phone_with_code: props.phone_with_code, country_code: props.country_code, first_name: props.first_name, last_name: props.last_name, email: props.email, password: password, referral_code: '' }
        })
            .then(async response => {
                setLoading(false);
