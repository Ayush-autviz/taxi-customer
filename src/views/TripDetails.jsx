                    ...
                    <ScrollView onScrollEndDrag={onScrollEndDrag}>
                        {on_load == 1 ?
                            <View style={{ padding: 10 }}>
                                <View style={{ bordeRadius: 10, borderWidth:1, borderColor: colors.theme_bg, padding:10, width:"80%"}}>
                                    <Text numberOfLines={2} style={{ color: colors.theme_fg_two, fontSize: 15, fontFamily: bold }}>Your OTP code is : #{data?.trip?.otp}</Text>
                                </View>
