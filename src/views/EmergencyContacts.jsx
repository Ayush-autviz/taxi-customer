...
import { StyleSheet, View, Text, Animated, TouchableOpacity, Image, FlatList, SafeAreaView } from 'react-native';
        ...
        return (
            <View style={styles.animationHeader}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <TouchableOpacity onPress={go_back} style={{ width: '30%', alignItems: 'flex-start', justifyContent: 'center', height: 60, paddingLeft: 17,paddingTop:35 }}>
