...
const Dashboard = (props) => {
    ...
    //  onPress={change_trip_type.bind(this, data)}
      return (
        <TouchableOpacity activeOpacity={1} onPress={change_trip_type.bind(this, data)} style={{ alignItems: 'center', justifyContent: 'center', width: '20%' }}>
          <View style={active_trip_type == data.id ? styles.active_vehicle_img : styles.vehicle_img} >
  ...
  const estimation_fare_list = () => {
    return estimation_fares.map((data) => {
      return (
        ...
        >
          <TouchableOpacity activeOpacity={1} onPress={change_vehicle_type.bind(this, data.id)} style={{ width: '100%', backgroundColor: colors.theme_bg_three, padding: 5, flexDirection: 'row', borderRadius: 10 }}>
            <View style={{ width: '25%', alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ height: 30, width: 30 }} >
                <Image style={{ height: undefined, width: undefined, flex: 1 }} source={{ uri: img_url + data.active_icon }} />
              </View>
              {data.eta != 0 ?
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: 10, fontFamily: regular }}>{data.eta}</Text>
                :
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: 10, fontFamily: regular }}>Not Available</Text>
              }
  ...
  const favourites_list = () => {
    if (customer_favourites.length == 0) {
      ...
      return customer_favourites.map((data) => {
        return (
          <TouchableOpacity activeOpacity={1} onPress={load_location.bind(this, data.lat, data.lng)} style={{ width: '100%', flexDirection: 'row', borderBottomWidth: 0.5, paddingBottom: 10, paddingTop: 10 }}>
  ...
  const recent_places_list = () => {
    if (customer_recent_places?.length == 0) {
      return (
        <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center',marginLeft:3 }}>
          <Text numberOfLines={2} ellipsizeMode='tail' style={{ fontSize: 12, color: colors.text_grey, fontFamily: regular,textAlign:'center' }}>No recent places searched</Text>
        </View>
      )
    } else {
  ...
  const screen_home = () => {
    return (
      <View>
        ...
        <Animated.View style={[{ transform: [{ translateY: home_comp_2 }] }, [{ position: 'absolute', bottom: 0, width: '100%', height: 180, backgroundColor: colors.theme_bg_three, }]]}>
          ...
          {active_trip_type != 2 ?
            <View>
              ...
              >
                <TouchableOpacity activeOpacity={1} onPress={open_location.bind(this, 2)} style={{ width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10, height: 50, flexDirection: 'row' }}>
                  <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center' }}>
  ...
  const screen_location = () => {
    return (
      <SafeAreaView >
        ...
        <Animated.View style={[{ transform: [{ translateY: drop_comp_3 }] }, [{ position: 'absolute', width: '100%', height: 100, alignItems: 'center', paddingBottom: 10, justifyContent: 'center', backgroundColor: colors.theme_bg_three,paddingVertical:20 }]]}>
          <View style={{ flexDirection: 'row', height: 90, width: '100%' }}>
            <TouchableOpacity onPress={back_to_home_screen.bind(this)} style={{ width: '20%', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Animated.View style={[{ transform: [{ translateY: drop_comp_2 }] }, [{ position: 'absolute', bottom: 10, width: '100%', height: 100, alignItems: 'center', justifyContent: 'center',marginBottom:25 }]]}>
          <TouchableOpacity activeOpacity={1} onPress={confirm_location.bind(this)} style={{ width: '90%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',marginBottom:30 }}>
        ...
        <Animated.View style={[{ transform: [{ translateY: drop_comp_4 }] }, [{ position: 'absolute', width: '100%', height: (screenHeight - 100), alignItems: 'center', paddingBottom: 10, justifyContent: 'flex-start', backgroundColor: colors.theme_bg_three }]]}>
          ...
          <ScrollView>
            <Text style={{ fontSize: 18, color: colors.text_grey, fontFamily: bold, marginLeft: 10 ,textAlign:'center'}}>Recent Places</Text>
            <ScrollView style={{ width: '100%', padding: 10 }}>
              {recent_places_list()}
              <View style={{ margin: 10 }} />
            </ScrollView>
            <Text style={{ fontSize: 18, color: colors.text_grey, fontFamily: bold, marginLeft: 10 ,textAlign:'center'}}>Favourites</Text>
            <ScrollView style={{ width: '100%', padding: 10 }}>
              {favourites_list()}
              <View style={{ margin: 10 }} />
            </ScrollView>
        ...
        <Animated.View style={[{ transform: [{ translateY: drop_comp_1 }] }, [{ position: 'absolute', width: '100%', alignItems: 'center', justifyContent: 'center' }]]}>
          ...
          >
            <View style={{ borderRadius: 10,marginTop:10, backgroundColor: colors.theme_bg_three }}>
  ...
  const screen_booking = () => {
    return (
      <View  >
        ...
        <Animated.View style={[{ transform: [{ translateY: book_comp_1 }] }, [{ position: 'absolute', width: '100%', height: (screenHeight - 260), paddingBottom: 10, justifyContent: 'flex-start', backgroundColor: colors.theme_bg_three }]]}>
          <View style={{ width: '100%', height: 100 }}>
            ...
            >
              <TouchableOpacity activeOpacity={1} onPress={booking_exit.bind(this)} style={{ width: '100%', backgroundColor: colors.theme_bg_three }}>
          ...
          <View style={{ height: 135, alignItems: 'center', justifyContent: 'flex-end', marginBottom: 40 }}>
            ...
            <View style={{ height: 40, width: '100%', flexDirection: 'row' }}>
              <TouchableOpacity style={{ width: '46%', alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
            ...
            {loading == false ?
              <View style={{ flexDirection: "row", width: '100%', alignItems: 'center', justifyContent: 'center', height: 50, }}>
                <TouchableOpacity onPress={call_zone.bind(this, 'null')} activeOpacity={1} style={{ width: '42%', backgroundColor: colors.btn_color, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                  <Text style={{ color: colors.theme_fg_two, fontSize: 16, color: colors.theme_fg_three, fontFamily: bold, padding: 10 }}>Book Self</Text>
                </TouchableOpacity>
                <View style={{ margin: 5 }} />
                <TouchableOpacity onPress={() => add_contact_RBSheet.current.open()} activeOpacity={1} style={{ width: '45%', backgroundColor: colors.btn_color, borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                  <Text style={{ color: colors.theme_fg_two, fontSize: 16, color: colors.theme_fg_three, fontFamily: bold, padding: 10 }}>Book for others</Text>
                </TouchableOpacity>
              </View>
              :
  ...
  const rb_add_contact = () => {
    return (
      ...
      >
        <View style={{ padding: 10, width: '100%' }}>
          <Text style={{ color: colors.theme_fg_two, fontSize: 25, fontFamily: normal }}>Someone else taking this ride ?</Text>
          <View style={{ margin: 5 }} />
          <TextInput
            ref={inputRef}
        ...
        <View style={{ flexDirection: 'row', width: '100%' }}>
          <View style={{ width: '1%' }} />
          <View style={{ width: '48%', alignItems: 'center', justifyContent: 'center' }}>
            <TouchableOpacity activeOpacity={1} onPress={() => add_contact_RBSheet.current.close()} style={{ width: '100%', backgroundColor: colors.lite_grey, borderRadius: 5, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ color: colors.theme_fg_two, fontSize: 16, color: colors.theme_fg_two, fontFamily: bold }}>Cancel</Text>
            </TouchableOpacity>
          </View>
          <View style={{ width: '1%' }} />
          <View style={{ width: '48%', alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end' }}>
            <TouchableOpacity activeOpacity={1} onPress={call_contact_number_validation.bind()} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 5, height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
   ...
   style={styles.container}
    >
      ...
      <View style={{ height: 100, width: 100, alignSelf: 'center', position: 'absolute', top: (screenHeight / 2) - 25 }}>
