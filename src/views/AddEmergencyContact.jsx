    ...
    const call_add_sos_contact = async () => {
        ...
        .then(async response => {
            ...
            if(response.data.status == 1){
                ...
                //dropDownAlertRef.alertWithType('success', response.data.message, 'Your Emergency contact added successfully.');
            }
        })
        .catch(error => {
            setLoading(false);
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Add emergengy contact name and number</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
